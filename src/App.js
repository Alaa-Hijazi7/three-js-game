    ...
    <>
      ...
      <Canvas camera={{ position: [0, 5, 12], fov: 50 }}>
        ...
        <Physics gravity={[0, -30, 0]} defaultContactMaterial={{ restitution: 1.1 }}>
          <Ball />
          <Paddle />
          <Enemy color="orannge" position={[2, 1, 0]} />
          <Enemy color="lightgreen" position={[-5, -1, 0]} />
          <Enemy color="red" position={[-8, 3, 0]} />
          <Enemy color="blue" position={[7, 4, 0]} />
